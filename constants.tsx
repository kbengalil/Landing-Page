...
export const TUINA_CONTENT: LandingContent = {
  ...
  sections: {
    what: {
      title: "מה זו טווינא?",
      content: [
        "טווינא היא שיטת עיסוי רפואי-ספורטיבי המבוצעת על מיטת טיפולים בלבוש מלא."
      ],
      content2: [
        "הטיפול משחרר ביעילות שרירים תפוסים, מהזרים דם וחמצן לרקמות ומשפר משמעותית את רמת האנרגיה והתפקוד במהלך יום העבודה."
      ]
    },
    about: {
      title: "מי אני?",
      content: [
        "שמי כפיר, בוגר מכללת רידמן ומכללת ווינגייט, מטפל ברפואה משלימה ומאמן כושר עם ניסיון של למעלה מ 20 שנה. אני מגיע למשרדי חברות עם מיטת הטיפולים ומעביר סדרות של טיפולים קצרים לעובדים בין אם זה טיפול כללי לגוף ונפש ובין אם טיפול ממוקד לפי בקשת העובד."
      ]
    },
    benefits: {
